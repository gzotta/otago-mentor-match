 ...
 *         for exclusions.
 */
public class MentorAuthenticator implements Jooby.Module {

    private final CredentialsValidator validator;
    private final List<String> noAuth = new ArrayList<>();

    public MentorAuthenticator(CredentialsValidator validator) {
        this.validator = validator;
    }

    public MentorAuthenticator(CredentialsValidator validator, List<String> noAuth) {
        this(validator);
    ...
    public void configure(Env env, Config conf, Binder binder) throws Throwable {
        ...
        }).name("MentorAuthenticator").excludes(noAuth);
